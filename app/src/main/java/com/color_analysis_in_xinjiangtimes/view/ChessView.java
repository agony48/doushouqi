...
public class ChessView extends FrameLayout {
    ...
    private void initView() {
        mImgChess = (ImageView) findViewById(R.id.img_chess);
        mLastHand = (ImageView) findViewById(R.id.last_hand);
        ...
        mImgLightBack = (ImageView) findViewById(R.id.chess_light_back);
