 ...
 */
public class FlyBannerTextView extends RelativeLayout {
    ...
    public FlyBannerTextView(Context context) {
        this(context, null);
    }

    public FlyBannerTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlyBannerTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setPoinstPosition(int position) {
        ...
        if (position == CENTER) {
            ...
            mPointRealContainerLp.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            mPointRealContainerLp.setMargins(0,0,12,0);
        }
    }
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (mIsImageUrl) {
                Picasso.with(getContext())
                        ...
                        .error(R.mipmap.default_rect_icon)
                        .placeholder(R.mipmap.default_rect_icon)
                        .into(imageView);
