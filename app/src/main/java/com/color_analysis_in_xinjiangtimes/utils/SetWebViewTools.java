...
public class SetWebViewTools {
    static String urlurl;
    /**
     * 加载webView的方法
     */
    public static void setWebView(final String urlload, final WebView webView, final Activity context) {
...
//        Toast.makeText(this,getIntent().getStringExtra("url"),3000).show();
        if (context.getIntent().getStringExtra("url").contains("http://")|context.getIntent().getStringExtra("url").contains("https://"))
        {
            webView.loadUrl(context.getIntent().getStringExtra("url"));
            URL url = null;
            try {
                url = new URL(context.getIntent().getStringExtra("url"));
            ...
            webView.loadUrl("http://"+context.getIntent().getStringExtra("url"));

            URL url = null;
            try {
                url = new URL("http://"+context.getIntent().getStringExtra("url"));
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
            urlurl= url.getHost();// 获取主机名
    ...
    public static void downloadByBrowser(Activity context, String url) {
    ...
    public static   boolean isyou(String s1, String s2){
